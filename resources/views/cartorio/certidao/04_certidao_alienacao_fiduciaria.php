...
<body>
    ...
    <div class="conteudo-principal">
        <p class="texto-justificado">
            <b>CERTIFICO</b> e dou fé, que a presente certidão é reprodução autêntica da ficha da matrícula nº
            <b>{{ $data['certidao_matricula_numero'] ?? '______' }}</b>. O imóvel dela objeto tem sua situação com
            referência a registros e averbações de <b>ALIENAÇÕES E CONSTITUIÇÕES DE ÔNUS OU DIREITOS, INCLUSIVE
                DECORRENTES DE CITAÇÕES EM AÇÕES REAIS OU PESSOAIS REIPERSECUTÓRIAS</b>, que estejam integralmente
            nela noticiados, e retrata a situação jurídica registral imobiliária até o último dia útil anterior à
            presente data, conforme dispõe os §§ 9º e 11º da Lei 6.015/73. (*)
        </p>
        ...
        <p class="texto-justificado">
            ...
            sua autenticidade em <span
                style="text-decoration: underline;">https://registradores.onr.org.br/validacao.aspx</span>,
        ...
        <p class="texto-justificado">
            § 11. No âmbito do registro de imóveis, a certidão de inteiro teor da matrícula conterá a reprodução de
            todo seu conteúdo e será suficiente para fins de comprovação de propriedade, direitos, ônus reais e
            restrições sobre o imóvel, independentemente de certificação específica pelo oficial. (Incluído pela
            Lei nº 14.382, de 2022)
        </p>
    </div>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="text-center" style="font-size: 10pt">
                                SINOP - MT,
                                {{ formatarDataPorExtenso(\Carbon\Carbon::parse($data['integrador_selo_data'] ?? now())->format('Y-m-d')) }}.
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="text-center" style="font-size: 10pt">
                                {{ $data['nome_registrador'] ?? 'André Luís Giocondo' }}</td>
                        </tr>
                        <tr>
                                            ...
                                            <table class="w-100">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="font-arial text-left font-size-12"
                                                        style="padding: 2px 0;">
                                                        {{ $data['integrador_selo_codigo_atos'] ?? '____' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="font-arial text-left font-size-12"
                                                    ...
                                                    <td class="font-arial text-left font-size-12"
                                                        style="padding: 2px 0;">
                                                        {{ $data['integrador_selo_prefixo'] ?? '____' }}-{{ $data['integrador_selo_numero'] ?? '____' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="font-arial text-left font-size-12"
                                                    ...
                                                    <td class="font-arial text-left font-size-12"
                                                        style="padding: 2px 0;">
                                                        {{ isset($data['integrador_selo_valor']) ? formatarDinheiro($data['integrador_selo_valor']) : 'R$ ____,__' }}
                                                    </td>
                                                </tr>
                                                <tr>
